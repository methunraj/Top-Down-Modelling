...
def render_executive_dashboard(distributed_market: pd.DataFrame, config_manager) -> None:
    ...
    st.plotly_chart(fig, use_container_width=True, key="executive_dashboard_market_evolution")
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="executive_dashboard_top_countries")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="executive_dashboard_concentration")
...
def render_enhanced_market_size_visualization(distributed_market: pd.DataFrame, config_manager) -> None:
    ...
    st.plotly_chart(fig, use_container_width=True, key=f"enhanced_market_viz_{chart_type.lower().replace(' ', '_')}")
...
def render_interactive_world_map(distributed_market: pd.DataFrame, config_manager) -> None:
    ...
    st.plotly_chart(fig, use_container_width=True, key="interactive_world_map")
    ...
    if selected_countries:
        render_country_comparison(distributed_market, selected_countries, comparison_metric, country_col, "world_map")

def render_country_comparison(data: pd.DataFrame, countries: List[str], metric: str, country_col: str, context: str = "main") -> None:
    """
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key=f"country_comparison_{context}_{metric.lower().replace(' ', '_')}")
...
def render_enhanced_visualization_interface(config_manager) -> None:
    ...
    with tab4:
        ...
        if selected_countries:
            ...
            render_country_comparison(distributed_market, selected_countries, comparison_metric, country_col, "country_comparison_tab")
        else:
