...
from src.streamlit.enhanced_visualization import EnhancedMarketVisualizer
from src.streamlit.growth_analysis_viz import GrowthAnalysisVisualizer
    ...
    def __init__(self):
        self.visualizers = {
            ...
            "Growth Analysis": {
                ...
                "class": GrowthAnalysisVisualizer(),
    ...
    def render_selected_visualization(self, viz_name: str):
        ...
        try:
            if viz_name == "Overview":
                # Executive dashboard
                visualizer.render_executive_dashboard(data, 'Country', 'Value', 'Year')
            
            elif viz_name == "Growth Analysis":
                # Growth analysis
                visualizer.render_growth_dashboard(data, 'Country', 'Value', 'Year')
