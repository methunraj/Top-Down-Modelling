...
class ProphetForecaster(BaseForecaster):
    ...
    def forecast(self, periods: int, frequency: str = 'Y') -> pd.DataFrame:
        ...
        forecast_dates = self.forecast['ds'].values
    ...
    def plot_components(self) -> Any:
        ...
        try:
            ...
            fig = plot_components(self.model, self.forecast)
            return fig
        except ImportError:
...
class XGBoostForecaster(BaseForecaster):
    ...
    def fit(self, data: pd.DataFrame) -> 'XGBoostForecaster':
        ...
        self.model.fit(X_train, y_train, eval_set=eval_set, eval_metric='rmse', verbose=False)
