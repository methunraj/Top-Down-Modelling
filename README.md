...
⚙️ **Highly Configurable** - YAML-based configuration system  
...
Optional economic/market indicators:
```csv
idGeo,Country,2020,2021,2022,2023
1,United States,21428700000,23315100000,25035200000,26854600000
2,Germany,3846400000,4223200000,4259200000,4371200000
```
